...
**Attention:** The presentation must be uploaded to the repository in the src folder (develop branch) with the file name internship_pres. The report must be prepared during the internship and uploaded to the platform before the mentor gives the second grade.You can also immediately place a link to the presentation (this could be a cloud storage service like Yandex Disk) in the project in the folder specified above. When the project is closed, the link will still be valid, the presentation will be available, and you will be able to supplement it and demonstrate it during the review.
