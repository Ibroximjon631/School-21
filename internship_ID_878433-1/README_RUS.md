...
- Вакансия должна соответствовать одной из специальностей из этого [списка](https://applicant.21-school.ru/specialties).
...
**Внимание:** Презентацию необходимо загрузить в репозиторий в папку *src* (ветка *develop*) с названием файла *internship_pres*.
Отчет должен быть подготовлен в течение стажировки и загружен на платформу до момента выставления ментором второй оценки.
Так же можно сразу разместить ссылку на презентацию (это может быть ссылка на облачное хранилище яндекс диск) в проекте в указанной выше папке. Когда проект закроется, то ссылка все еще будет актуальна, презентация будет доступна, будет возможность ее дополнить и продемонстрировать на проверке.
